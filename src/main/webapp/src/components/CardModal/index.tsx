...
export default class CardModal extends React.Component<CardModalProps, CardModalState & ModalState> {
    ...
    getCardSnapshot = () => {
        ...
        return {
            creator: this.props.card ? this.props.card.creator : { userName: "", email: "" },
            title: state.title,
    ...
    handleInputChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        this.setState({ [id]: value } as Pick<CardModalState, keyof CardModalState>);
    };
        ...
        return (
            <ModalWindow close={this.props.close}>
                <div>
                    ...
                    <input onChange={this.handleInputChange} id="title" value={this.state.title} />
                </div>
                <div>
                    <label htmlFor="description">описание</label>
                    <textarea onChange={this.handleTextAreaChange} id="description" value={this.state.description} />
                </div>
                <div>
                    <label htmlFor="members">участники</label>
                    <input onChange={this.handleInputChange} id="members" value={this.state.members} />
                </div>
                <div>
                    <label htmlFor="tags">тэги</label>
                    <input onChange={this.handleInputChange} id="tags" value={this.state.tags} />
                </div>
                <div>
                    <label htmlFor="place">место</label>
                    <input onChange={this.handleInputChange} id="place" value={this.state.place} />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input onChange={this.handleInputChange} id="x" value={this.state.x} />
                    <label htmlFor="y">y</label>
                    <input onChange={this.handleInputChange} id="y" value={this.state.y} />
                </div>
